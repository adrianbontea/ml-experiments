...
class PreProcessingExperiment(HousingExperimentBase):
    def run(self):
        ...
        # Now this cannot fit anymore in a single column of the predictors_tr DataFrame as that needs to be a Pandas Series...
        ...
        predicors_tr = pipeline.fit_transform(predictors_num)
